...
@Configuration
@EnableJpaRepositories(basePackages = "io.tpd.springbootcucumber", entityManagerFactoryRef = "matriculaEntityManager", transactionManagerRef = "matriculaTransactionManager")
